...
BINARY=${BINARY:-maanyappd}
BASE_DIR=./data
CHAINID=${CHAINID:-test-1}
STAKEDENOM=${STAKEDENOM:-uapp}
...
MIN_GAS_PRICES_DEFAULT='[{"denom":"ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2","amount":"0"},{"denom":"uapp","amount":"0"}]'
...
set_genesis_param_jq ".app_state.feemarket.params.fee_denom"       "\"uapp\""                             # feemarket
