...
// NeutronAppConfig defines the config structure of the maanyappd app.toml file. Specifically,
...
// initAppConfig initializes a default application configuration for maanyappd.
...
func runConfigCmd(cmd *cobra.Command, args []string) error {
	...
	ncc := NeutronCustomClient{
		*conf,
        os.Getenv("MAANYAPPD_GAS"),
        os.Getenv("MAANYAPPD_GAS_PRICES"),
        os.Getenv("MAANYAPPD_GAS_ADJUSTMENT"),

        os.Getenv("MAANYAPPD_FEES"),
        // os.Getenv("MAANYAPPD_FEE_GRANTER"),
        // os.Getenv("MAANYAPPD_FEE_PAYER"),

        os.Getenv("MAANYAPPD_NOTE"),
	}
