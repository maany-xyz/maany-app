...
import (
	...
	"github.com/maany-xyz/maany-app/x/lockup/client/cli"
	"github.com/maany-xyz/maany-app/x/lockup/keeper"
	"github.com/maany-xyz/maany-app/x/lockup/types"
)
...
func NewAppModule(keeper keeper.Keeper,
    accountKeeper stakingtypes.AccountKeeper, bankKeeper types.BankKeeper,
) AppModule {
	return AppModule{
...
// Simulation code removed in this build.
