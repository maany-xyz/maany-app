...
import (
	...
	testutil_keeper "github.com/maany-xyz/maany-app/testutil/feerefunder/keeper"
	mock_types "github.com/maany-xyz/maany-app/testutil/mocks/feerefunder/types"
...
func TestDistributeAcknowledgementFee(t *testing.T) {
	...
	validFee := types.Fee{
		RecvFee:    nil,
        AckFee:     sdk.NewCoins(sdk.NewCoin(appparams.DefaultDenom, math.NewInt(1001))),
        TimeoutFee: sdk.NewCoins(sdk.NewCoin(appparams.DefaultDenom, math.NewInt(2001))),
	}
	packet := types.PacketID{
		ChannelId: "channel-0",
		PortId:    "transfer",
...
func TestFeeInfo(t *testing.T) {
	...
	validFee := types.Fee{
		RecvFee:    nil,
        AckFee:     sdk.NewCoins(sdk.NewCoin(appparams.DefaultDenom, math.NewInt(1001))),
        TimeoutFee: sdk.NewCoins(sdk.NewCoin(appparams.DefaultDenom, math.NewInt(1001))),
	}
