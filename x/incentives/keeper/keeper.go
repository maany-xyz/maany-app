...
import (
	...
	"github.com/maany-xyz/maany-app/osmoutils"
...
func NewKeeper(storeKey storetypes.StoreKey, paramSpace paramtypes.Subspace, ak types.AccountKeeper, bk types.BankKeeper, lk types.LockupKeeper, ek types.EpochKeeper, ck types.CommunityPoolKeeper, txfk types.TxFeesKeeper, pik types.PoolIncentiveKeeper, prk types.ProtorevKeeper) *Keeper {
