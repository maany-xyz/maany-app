...
import (
    ...
    "github.com/maany-xyz/maany-app/osmoutils/osmocli"
...
func NewCreateGaugeCmd() *cobra.Command {
    cmd := &cobra.Command{
        ...
        Short: "create a gauge to distribute rewards to users (only ByDuration; pools disabled). Set poolId = 0.",
        ...
        RunE: func(cmd *cobra.Command, args []string) error {
            ...
            if poolId != 0 {
                return errors.New("pools disabled: poolId must be 0")
            }
...
func NewCreateGroupCmd() *cobra.Command {
    // Pools disabled: hide/disable this command.
    return &cobra.Command{Use: "create-group (disabled)", RunE: func(cmd *cobra.Command, args []string) error { return errors.New("create-group is disabled: pools are not supported") }}
}
