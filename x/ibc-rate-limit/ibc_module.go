...
import (
	...
	"github.com/maany-xyz/maany-app/x/ibc-hooks/utils"
	...
	"github.com/maany-xyz/maany-app/x/ibc-rate-limit/types"
)
...
func (im *IBCModule) OnRecvPacket(
	...
	if err != nil {
		if strings.Contains(err.Error(), types.RateLimitExceededSubStr) {
...
func (im *IBCModule) OnAcknowledgementPacket(
	...
	// See: https://github.com/maany-xyz/maany-app/pull/8308 & https://github.com/maany-xyz/maany-app/pull/8420
